...
- Credit later solutions, counterexamples, corrections, related theorems, and borrowed methods with precise scope. An unsuccessful search does not establish novelty or continuing openness.
- Use only necessary quotations and artifacts, respect source licenses, and do not upload bulk PDFs or source databases.
