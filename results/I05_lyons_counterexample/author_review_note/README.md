...
- [`verify_exact.py`](verify_exact.py): a self-contained standard-library checker for the boundary limit, interior Hessian, endpoint feasibility, eventwise endpoint equality, and finite midpoint entropy gap.
- [`boundary_table.csv`](boundary_table.csv): an optional readable copy of the 32 boundary terms; the checker does not read it.
- [`verification_summary.md`](verification_summary.md): two fresh read-only review verdicts and frozen file hashes.
